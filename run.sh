...
gnome-terminal --working-directory=${bsn}/configurations/property_analyzer/P9 -e 'roslaunch ecg_analyzer.launch'
gnome-terminal --working-directory=${bsn}/configurations/property_analyzer/P9 -e 'roslaunch thermometer_analyzer.launch'
