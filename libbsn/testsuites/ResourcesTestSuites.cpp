...
TEST_F(ResourcesTest, BasicConstruct) {
    ...
    ASSERT_EQ(true, resource.getCapacity() == 100);
    ASSERT_EQ(true, resource.getCurrentLevel() == 100);
    ASSERT_EQ(true, resource.getUnit() == 1);
}

TEST_F(ResourcesTest, Construct) {
    ASSERT_EQ(true, resource.getId() == "Battery");
    ASSERT_EQ(true, resource.getCapacity() == 10);
    ASSERT_EQ(true, resource.getCurrentLevel() == 10);
    ASSERT_EQ(true, resource.getUnit() == 0.1);
}
...
TEST_F(ResourcesTest, ResourceConsume) {
    ...
    ASSERT_EQ(true, resource.getCurrentLevel() == 9.5);
}
...
TEST_F(ResourcesTest, ResourceGeneration) {
    ...
    ASSERT_EQ(true, resource.getCurrentLevel() == 9.7);
}